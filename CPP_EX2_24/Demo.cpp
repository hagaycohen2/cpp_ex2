...
int main() {
    ...
    g1.printGraph();  // Should print the graph: "Graph with 3 vertices and 3 edges \n 0 1 0 \n 1 0 1 \n 0 1 0"
    ...
    hagay::Graph g3 = g1 + g2;  // Add the two graphs together.
    cout << g3;                 // Should print the matrix of the graph: [0, 2, 1], [2, 0, 3], [1, 3, 0]

    hagay::Graph g4 = g1 * g2;  // Multiply the two graphs together.
    ...
    try {
        hagay::Graph g6 = g5 * g1;  // Multiply the two graphs together.
